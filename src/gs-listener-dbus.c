...
#define GS_LISTENER_SERVICE   "org.kylin.ScreenSaver"
#define GS_LISTENER_PATH      "/org/kylin/ScreenSaver"
#define GS_LISTENER_INTERFACE "org.kylin.ScreenSaver"
                        ...
                        GSListenerRefEntry *entry)
{
	...
	{
		/* proxy inhibit over to kylin session */
                           ...
                           guint32     cookie)
{
	...
	if (entry_type == REF_ENTRY_TYPE_INHIBIT)
	{
		/* remove inhibit from kylin session */
               ...
               dbus_bool_t     local_interface)
{
	...
	xml = g_string_append (xml,
	                       "  <interface name=\"org.kylin.ScreenSaver\">\n"
	                       "    <method name=\"Lock\">\n"
	                       "    </method>\n"
	                       "    <method name=\"Cycle\">\n"
	                       "    </method>\n"
                                     ...
                                     dbus_bool_t     local_interface)
{
	...
	else if (dbus_message_is_signal (message, CK_SESSION_INTERFACE, "ActiveChanged"))
	{
		 ...
		 * kylin-screensaver uses `active' to mean `is the
