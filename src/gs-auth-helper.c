...
/* The idea here is to be able to run ukui-screensaver-dialog without any setuid bits.
         ...
         gboolean    verbose)
{
	...
	if (pid == 0)
	{
		...
		execlp (PASSWD_HELPER_PROGRAM, PASSWD_HELPER_PROGRAM, "ukui-screensaver", user, NULL);
		if (verbose)
		{
