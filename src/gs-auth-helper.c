...
/* The idea here is to be able to run kylin-screensaver-dialog without any setuid bits.
         ...
         gboolean    verbose)
{
	...
	if (pid == 0)
	{
		...
		execlp (PASSWD_HELPER_PROGRAM, PASSWD_HELPER_PROGRAM, "kylin-screensaver", user, NULL);
		if (verbose)
		{
